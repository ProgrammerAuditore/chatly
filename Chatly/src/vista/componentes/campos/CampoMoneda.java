    ...
    public void keyTyped(KeyEvent evt) {
        ...
        if( charCap == '.' || Character.isDigit(charCap) ){
           if (charCap == '.') {
                if (getText().contains(".")) {
                    evt.consume();
                    JOptionPane.showMessageDialog(null, SrcChatly.idioma.getProperty("campoMoneda.keyTyped.msg1"));
            ...
            if( Character.isLetter( charCap ) ){
                evt.consume();
                JOptionPane.showMessageDialog(null, SrcChatly.idioma.getProperty("campoMoneda.keyTyped.msg2"));
