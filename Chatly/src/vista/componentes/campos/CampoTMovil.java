 ...
 * @author victo
 */
public class CampoTMovil extends JTextField implements FocusListener, KeyListener{
    ...
    private void setToolTip(){
        String aqui= SrcChatly.idioma.getProperty("componente.setToolTip.aqui");
    ...
    public void keyTyped(KeyEvent evt) {
        ...
        if ( this.getText().length() >= 10 ){
            evt.consume(); 
            JOptionPane.showMessageDialog(null, SrcChatly.idioma.getProperty("campoTMovil.keyTyped.msg1"));
            return;
        }
        ...
        if ( !(charCap >= '0' && charCap <= '9')) {
            ...
            if( Character.isLetter( charCap ) ){
                evt.consume();
                JOptionPane.showMessageDialog(null, SrcChatly.idioma.getProperty("campoTMovil.keyTyped.msg2"));
