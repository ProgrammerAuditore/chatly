...
WizardStyle=modern
; Para modificar los variables de entorno
...
Root: HKCU; Subkey: "Environment"; ValueType:string; ValueName:"MFL_INSTALL_PATH"; ValueData:"{app}"; Flags: preservestringtype uninsclearvalue
Root: HKCU; Subkey: "Environment"; ValueType:string; ValueName:"MFL_JRE_PATH"; ValueData:"{app}\lib\jre\bin"; Flags: preservestringtype uninsclearvalue

[Code]
#include "EnviromenPath.iss"
// Verificar los cambios la ruta de JRE al PATH
//procedure CurStepChanged(CurStep: TSetupStep);
//begin
//    if (CurStep = ssPostInstall) and IsTaskSelected('envPath')
//    then EnvAddPath(ExpandConstant('{app}') +'\lib\jre\bin');
//end;

// Agregar la ruta de JRE al PATH
procedure CurStepChanged(CurStep: TSetupStep);
begin
...
begin
    ...
    then EnvRemovePath(ExpandConstant('{app}') +'\lib\jre\bin');
end;
